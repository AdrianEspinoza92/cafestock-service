...
- ¿Qué sucede si se intenta editar el precio de un producto que ya tiene
  ...
  debe modificarse; solo las ventas futuras usan el nuevo precio.
- ¿Qué sucede si se intenta desactivar un insumo que está asociado a una
  receta activa? El sistema debe permitir la desactivación pero advertir
  que la receta que lo usa quedará afectada (no podrá completarse hasta que
  se actualice o se reactive el insumo).
...
- **FR-011**: El sistema DEBE preservar sin cambios las ventas ya
  ...
  producto o insumo asociado sea editado o desactivado posteriormente.
...
- **SC-003**: El 100% de las ventas registradas antes de una edición o baja
  de un producto/insumo conservan sus datos originales (incluyendo precio)
  después de dicha edición o baja.
